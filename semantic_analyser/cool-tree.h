...
public:
  ...
  virtual void push_hierarchy_attributes_scope()= 0;
...
public:
   ...
   virtual bool is_conformant(Expressions expressions) = 0;
...
public:
   ...
   virtual bool semantic_analysis() = 0;
   virtual bool is_null_expr() { return false; }
...
public:
   ...
   void push_hierarchy_attributes_scope();
...
public:
   ...
   bool is_conformant(Expressions expr);
...
public:
   ...
   bool is_conformant(Expressions expressions) { return false; }
#ifdef Feature_SHARED_EXTRAS
   Feature_SHARED_EXTRAS
#endif
#ifdef attr_EXTRAS
...
public:
   ...
   void dump(ostream& stream, int n);
   bool semantic_analysis();
   virtual bool is_null_expr() { return true; }
#ifdef Expression_SHARED_EXTRAS
   Expression_SHARED_EXTRAS
#endif
